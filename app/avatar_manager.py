...
# avatar manager: safe decode, center-crop, final 256x256
class avatarManager:
    ...
    def set_avatar(self, person_name: str, image_path: Path) -> Path:
        ...
        target_path = person_folder / "avatar.png"
    ...
    def remove_avatar(self, person_name: str):
        avatar_path = self.root / person_name / "avatar.png"
